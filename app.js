...
setTimeout(showContent=>console.log('I am problem number one'),5000);
...
const AskInput=()=>{
    let numberInput=prompt("Enter an interger number");
    numberInput=parseInt(numberInput);
    if(numberInput){
        let result=numberInput+200;
        console.log(result);
    }
}
...
const showURL=()=>{
    const isShow=confirm("Want to see URL ?");
    if(isShow){
